...
const SmallMenu = React.forwardRef<HTMLDivElement, {}>((props, ref) => {
    ...
    return (
        <div ref={ref} style={{ background: '#FFFFFF', position: 'absolute', right: '30px', top: '100px', width: '220px', height: '200px', borderTopLeftRadius: '15px', borderTopRightRadius: '15px', zIndex: 1000 }}>
