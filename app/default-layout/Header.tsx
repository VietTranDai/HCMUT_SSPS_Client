...
const Header = () => {
    return (
        <div style={{ height: '90px', display: 'flex', justifyContent: 'end', alignItems: 'center', background: '#FFFFFF', position: 'relative' }}>
            ...
            <div className="login-button" style={{ color: '#7E7E7E', fontSize: '18px', borderLeft: '1px solid #A1A1A1', height: '70px', display: 'flex', alignItems: 'center', paddingLeft: '50px', paddingRight: '50px' }}>
                Đăng nhập
            </div>
        </div>
    );
